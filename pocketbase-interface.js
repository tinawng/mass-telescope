export default class PocketBaseInterface {
  ...
  async create(body) {
    ...
    await fetch(`${this.api_url}`, { headers: this.fetch_headers, method: 'POST', body: JSON.stringify(body) })
  }
  /**
  ...
  async update(id, body) {
    ...
    await fetch(`${this.api_url}/${id}`, { headers: this.fetch_headers, method: 'PATCH', body: JSON.stringify(body) })
  }
