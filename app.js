...
const tanabata_api = got.extend({ prefixUrl: "https://tanabata.tina.cafe/merge/", headers: { 'X-API-KEY': process.env.TANABATA_API_KEY }, responseType: 'json', resolveBodyOnly: true, retry: { limit: 10, methods: ['POST'], calculateDelay: ({ attemptCount }) => attemptCount * 2000 } });
